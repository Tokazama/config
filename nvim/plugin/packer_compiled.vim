...
_G.packer_plugins = {
  ...
  ["one-nvim"] = {
    loaded = true,
    path = "/Users/zchristensen/.local/share/nvim/site/pack/packer/start/one-nvim"
  },
  ["packer.nvim"] = {
    loaded = false,
    needs_bufread = false,
  ...
  ["zen-mode.nvim"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/Users/zchristensen/.local/share/nvim/site/pack/packer/opt/zen-mode.nvim"
  }
}
